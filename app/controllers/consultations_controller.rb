class ConsultationsController < ApplicationController
  ...
  def create
    @consultation = Consultation.new(consultation_params.merge({user_id: current_user.id}))
    ...
    respond_to do |format|
      if @consultation.save
        ...
        ConsultationMailer.with(user: current_user, consultation: @consultation).consultation_mailer.deliver_later
      else
